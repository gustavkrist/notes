...
**Correct Answer**  
Outcome is amount of throws before 3rd heads, so sample space is
$$\Omega = \{x \in \mathbb{N}, \quad x \geq 3\}$$
...
$$
\begin{aligned}
P(7) &= \left( \begin{smallmatrix} 6 \\ 2\end{smallmatrix} \right) \cdot (1-p)^4p^2 \cdot p \\
&= \frac{6!}{2!4!}p^3(1-p)^4
\end{aligned}
$$
