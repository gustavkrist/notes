...
- How much data do we need?
    - For training: ca. 1 example per model parameter
    - Less for evaluation
...
![Instructions to human annotators](assets/Data%20Annotation_2022-04-28-11-38-07.png){ width="70%" }
...
![Crowdsourcing proficiency](assets/Data%20Annotation_2022-04-28-11-41-42.png){ width="70%" }
